# Current intention:
# Creating a driver script that takes as input a fermi surface anisotropy ν and
# runs simulations for a set of different g by distributing the states over
