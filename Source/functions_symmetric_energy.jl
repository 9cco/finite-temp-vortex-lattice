...
#    Aᵣ₋₂₁ = two_pi*c.f*(h_pos-3)
    ...
    # Kinetic energy Fₖ
    Fₖ = -0.5*(ϕᵣ₊₁.u⁺*ϕᵣ₋₁.u⁺*cos(ϕᵣ₊₁.θ⁺-ϕᵣ₋₁.θ⁺ - (ϕ.A[1]+ϕᵣ₋₁.A[1]))
...
#	@test Fₖ == -(ϕ.u⁺^2+ϕ.u⁻^2)
    # Potential energy Fᵥ
    #Fᵥ = ((ϕ.u⁺*ϕ.u⁻)^2*(2+c.ν*cos(2*(ϕ.θ⁺-ϕ.θ⁻))) + 0.5*(ϕ.u⁺^4 + ϕ.u⁻^4))
    Fᵥ = 0.5*(ϕ.u⁺^4 + ϕ.u⁻^4)
...
+ c.κ₅*(ϕᵣ₊₃.u⁺*ϕᵣ₋₃.u⁺*cos(ϕᵣ₊₃.θ⁺-ϕᵣ₋₃.θ⁺-(ϕ′.A[3]+ϕᵣ₋₃.A[3])) - ϕᵣ₊₃.u⁺*ϕᵣ₋₃.u⁺*cos(ϕᵣ₊₃.θ⁺-ϕᵣ₋₃.θ⁺-(ϕ.A[3]+ϕᵣ₋₃.A[3])) 
+ ϕ′.u⁺*ϕᵣ₋₃₃.u⁺*cos(ϕ′.θ⁺-ϕᵣ₋₃₃.θ⁺-(ϕᵣ₋₃.A[3]+ϕᵣ₋₃₃.A[3])) - ϕ.u⁺*ϕᵣ₋₃₃.u⁺*cos(ϕ.θ⁺-ϕᵣ₋₃₃.θ⁺-(ϕᵣ₋₃.A[3]+ϕᵣ₋₃₃.A[3])) 
+ ϕᵣ₊₃₃.u⁺*ϕ′.u⁺*cos(ϕᵣ₊₃₃.θ⁺-ϕ′.θ⁺-(ϕᵣ₊₃.A[3]+ϕ′.A[3])) - ϕᵣ₊₃₃.u⁺*ϕ.u⁺*cos(ϕᵣ₊₃₃.θ⁺-ϕ.θ⁺-(ϕᵣ₊₃.A[3]+ϕ.A[3]))

+ ϕᵣ₊₃.u⁻*ϕᵣ₋₃.u⁻*cos(ϕᵣ₊₃.θ⁻-ϕᵣ₋₃.θ⁻-(ϕ′.A[3]+ϕᵣ₋₃.A[3])) - ϕᵣ₊₃.u⁻*ϕᵣ₋₃.u⁻*cos(ϕᵣ₊₃.θ⁻-ϕᵣ₋₃.θ⁻-(ϕ.A[3]+ϕᵣ₋₃.A[3])) 
+ ϕ′.u⁻*ϕᵣ₋₃₃.u⁻*cos(ϕ′.θ⁻-ϕᵣ₋₃₃.θ⁻-(ϕᵣ₋₃.A[3]+ϕᵣ₋₃₃.A[3])) - ϕ.u⁻*ϕᵣ₋₃₃.u⁻*cos(ϕ.θ⁻-ϕᵣ₋₃₃.θ⁻-(ϕᵣ₋₃.A[3]+ϕᵣ₋₃₃.A[3])) 
+ ϕᵣ₊₃₃.u⁻*ϕ′.u⁻*cos(ϕᵣ₊₃₃.θ⁻-ϕ′.θ⁻-(ϕᵣ₊₃.A[3]+ϕ′.A[3])) - ϕᵣ₊₃₃.u⁻*ϕ.u⁻*cos(ϕᵣ₊₃₃.θ⁻-ϕ.θ⁻-(ϕᵣ₊₃.A[3]+ϕ.A[3]))))
    
    δE += 0.5*c.κ₅*(ϕ′.u⁺^2 + ϕ′.u⁻^2 - ϕ.u⁺^2 - ϕ.u⁻^2)
    
    # Potential energy terms
#    δE += ((ϕ′.u⁺*ϕ′.u⁻)^2*(2+c.ν*cos(2*(ϕ′.θ⁺-ϕ′.θ⁻))) - (ϕ.u⁺*ϕ.u⁻)^2*(2+c.ν*cos(2*(ϕ.θ⁺-ϕ.θ⁻))) 
#        + 0.5*(ϕ′.u⁺^4-ϕ.u⁺^4+ϕ′.u⁻^4-ϕ.u⁻^4))
#    δE += 0.5*(ϕ′.u⁺^4-ϕ.u⁺^4+ϕ′.u⁻^4-ϕ.u⁻^4)
